...
const Hero: React.FC = () => (
  <section className="relative pt-24 pb-32 px-4 shadow-sm overflow-hidden bg-slate-50">
    <div className="absolute inset-0 z-0">
      <img src="https://images.unsplash.com/photo-1632759145351-1d592919f522?auto=format&fit=crop&w=1200&q=80" alt="Roofing Professionals" className="w-full h-full object-cover origin-center" />
